...
** These node types are further described by their content model (e.g., simple may be verbatim, raw, regular/prose/paragraph, or empty; compound may be section or non-section).
