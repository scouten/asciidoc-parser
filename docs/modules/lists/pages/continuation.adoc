...
In additional to unordered and ordered lists, list continuations are supported for callout and description lists as well.
On this page, the term list item refers to any list item in an unordered, ordered, callout, and description list.
For a description list, it refers specifically to the description of the list item (not the term).
