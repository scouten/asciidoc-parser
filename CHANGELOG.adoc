...
* Revised the scope of the project (#11)
* Resynchronized the AsciiDoc user documentation from the initial contribution repository
* Reconfigured this repository as the official source of the AsciiDoc user documentation
