...
mod bulleted_lists {
    mod simple_lists {
        ...
        #[test]
        fn a_list_item_for_a_different_list_terminates_non_indented_paragraph_for_text_of_list_item_example_2()
         {
            ...
            assert_eq!(
                ...
                Document {
                    ...
                    blocks: &[Block::List(ListBlock {
                        ...
                        items: &[
                            Block::ListItem(ListItem {
                                marker: ListItemMarker::Bullet(Span {
                                    data: "•",
                                    line: 1,
                                    col: 2,
                                    offset: 1,
        ...
        fn asterisk_elements_separated_by_a_line_comment_offset_by_blank_lines_should_not_merge_lists()
         {
            ...
            // NOTE: This test will change when we implement line comment parsing.
            ...
            assert_eq!(
                ...
                Document {
                    ...
                    catalog: Catalog {
                        ...
                        reftext_to_id: HashMap::from([("Section", "_section",),]),
                    },
                }
            );
        }
...
"###
    ...
    catalog: Catalog {
        ...
        #[test]
        #[ignore] // TEMPORARY ignoring this one for now
...
"###
        ...
        fn level_of_unordered_list_should_match_section_level() {
            let doc = Parser::default().parse("== Parent Section\n\n* item 1.1\n ** item 2.1\n  *** item 3.1\n ** item 2.2\n* item 1.2\n\n=== Nested Section\n\n* item 1.1");
