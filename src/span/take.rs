...
impl<'src> Span<'src> {
    ...
    pub(crate) fn take_prefix(self, prefix: &str) -> Option<ParseResult<'src, Self>> {
    ...
    pub(crate) fn take_whitespace(self) -> ParseResult<'src, Self> {
    ...
    pub(crate) fn take_required_whitespace(self) -> Option<ParseResult<'src, Self>> {
    ...
    pub(crate) fn take_while<P>(self, predicate: P) -> ParseResult<'src, Self>
    where
        P: Fn(char) -> bool,
    {
